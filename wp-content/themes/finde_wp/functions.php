...
function finde_wp_scripts() {
	...
	wp_enqueue_style( 'finde_custom', get_template_directory_uri() . '/assets/css/finde.css', array(), '2.5' );
	
	wp_style_add_data( 'finde_wp-style', 'slick', 'slick-theme', 'plyr', 'finde_custom', 'replace' );
